...
Route::prefix('staff')->name('staff.')->group(function () {
    ...
    Route::put('/pesanan/proses/{id}', [DashboardController::class, 'proses'])->name('pesanan.proses');
    Route::put('/pesanan/selesai/{id}', [DashboardController::class, 'selesai'])->name('pesanan.selesai');
});
